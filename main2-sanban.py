...
for i in range(324):
    ...
    res[0] = triposition(A0, A_dis[0], A1, A_dis[1], A2, A_dis[2], A3, A_dis[3])
    err[0] = disErr_scene1(res[0], A_dis)

    global_best_x_list_R.append(res[0])
    global_best_y_list_R.append(err[0])
    print(i, '正常: best_x:', res[0], 'best_y:', err[0])
    ...
    global_best_x_list_W_e1.append(res[0])
    global_best_y_list_W_e1.append(err[0])
    #print(i, '异常-1: best_x:', res[0], 'best_y:', err[0])
    ...
    global_best_x_list_W_e2.append(res[0])
    global_best_y_list_W_e2.append(err[0])
    #print(i, '异常-2: best_x:', res[0], 'best_y:', err[0])
